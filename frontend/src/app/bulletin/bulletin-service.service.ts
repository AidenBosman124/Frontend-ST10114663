...
export class BulletinServiceService {
  ...
  {
    this.http.post<{message:string,bulletin:any}>('https://localhost:3000/api/posts/create',{id:pid,text:ptext})
  ...
  getbulletin_service(){
    this.http.get<{message:string,bulletin:any}>('https://localhost:3000/api/posts')
    .subscribe((thebulletin)=>
    {
  ...
  deletebulletin_service(bulletinid: string){
    this.http.delete<{message:string,bulletin:any}>('https://localhost:3000/api/posts/id' + bulletinid)
    .subscribe((thebulletin)=>
    {
